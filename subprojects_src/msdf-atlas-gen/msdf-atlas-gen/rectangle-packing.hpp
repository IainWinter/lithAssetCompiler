...
static inline void copyRectanglePlacement(Rectangle &dst, const Rectangle &src) {
    dst.x = src.x;
    dst.y = src.y;
}

static inline void copyRectanglePlacement(OrientedRectangle &dst, const OrientedRectangle &src) {
    dst.x = src.x;
    dst.y = src.y;
